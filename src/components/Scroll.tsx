    ...
    <div className="">
        ...
        <div className="relative">
          ...
          <div className="left top-1/2 absolute z-10 -translate-y-1/2 left-2">
            <Btn.Chevron onClick={() => handleScroll()}  extraClass="bg-[#fffce2]"/>
          </div>

          <div className="right  top-1/2 absolute z-10 -translate-y-1/2 right-2">
            <Btn.Chevron onClick={() => handleScroll("right")}  direction="right" extraClass="bg-[#fffce2]" />
          </div>



          <div ref={scrollRef} className="w-full overflow-x-scroll scrollbar-thin relative z-0">
